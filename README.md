...
| `tools/visual-diff.mjs` | Pixel-diffs a screenshot against `bazinger.png` → a red heatmap (`diff.png`). The catch-all net. |
...
node tools/visual-diff.mjs index.html bazinger.png   # pixel-diff -> diff.png
```
